...
from webdriver_manager.utils import download_driver, download_file
...
class DriverManager(object):
    ...
    def _get_driver_path(self, driver):
        ...
        binary_path = self.driver_cache.find_driver_in_cache(browser_version, driver_name, os_type,
                                                             driver_version)
        if binary_path:
            return binary_path
